                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" maxlength="10" v-on:keypress="isNumber(event)" v-model="telefono" class="form-control" placeholder="Teléfono">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" maxlength="10" v-on:keypress="isNumber(event)" v-model="tel_contacto" class="form-control" placeholder="Teléfono del contacto">
                                    </div>
                                </div>
